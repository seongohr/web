...
//    private FloatingActionButton fab;
    ...
    public static MainSummaryFragment newInstance(int position, String forecastData,
                                                  String city) {
        MainSummaryFragment summaryFragment = new MainSummaryFragment();
        position = position + 1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainSummaryFragment.this.getActivity(), Detail.class);
...
//        fab = (FloatingActionButton) view.findViewById(R.id.favorite);
...
//                        if(position == 0) {
////                            view.fab.setImageResource(R.drawable.map_marker_minus);
//                            fab.hide();
//                        }
//                        flag = true;
//                        Toast.makeText(getActivity().getApplicationContext(),city + " was added to favorite", Toast.LENGTH_SHORT).show();
//                    }
//                    else {
//                        fab.setImageResource(R.drawable.map_marker_plus);
//                        flag = false;
//                        Toast.makeText(getActivity().getApplicationContext(),city + " was removed from favorite", Toast.LENGTH_SHORT).show();
//                    }
//
//            }
//        });
